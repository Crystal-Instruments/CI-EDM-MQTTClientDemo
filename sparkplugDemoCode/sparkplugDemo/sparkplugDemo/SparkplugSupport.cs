...
namespace sparkplugDemo
{
    public static class MetricNames
    {
        ...
        public const string METRIC_NDATA_TEST_RUNLOGEVENT = "Properties/Test/RunLogEvent";
        ...
        public static List<Metric> VCSMetrics { get; set; } = new List<Metric>()
        {
            ...
            new Metric(){Name = "Signals/Peak(Ch1)/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Peak(Ch1)/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Peak(Ch1)/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/RMS(Ch1)/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/RMS(Ch1)/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/RMS(Ch1)/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/PkPk(Ch1)/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/PkPk(Ch1)/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/PkPk(Ch1)/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Block(Ch1)/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Avg(Ch1)/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Avg(Ch1)/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Avg(Ch1)/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/StDev(Ch1)/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/StDev(Ch1)/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/StDev(Ch1)/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Max(Ch1)/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Max(Ch1)/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Max(Ch1)/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Min(Ch1)/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Min(Ch1)/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Min(Ch1)/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Variance(Ch1)/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Variance(Ch1)/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Variance(Ch1)/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/FFT(Ch1)/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/FFT(Ch1)/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/FFT(Ch1)/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/PosSRS(Ch1)/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/PosSRS(Ch1)/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/PosSRS(Ch1)/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/NegSRS(Ch1)/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/NegSRS(Ch1)/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/NegSRS(Ch1)/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/MaxiMaxSRS(Ch1)/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/MaxiMaxSRS(Ch1)/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/MaxiMaxSRS(Ch1)/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            ...
            new Metric(){Name = "Signals/HighAbort(f) 1/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/HighAlarm(f) 1/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/LowAbort(f) 1/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/LowAlarm(f) 1/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Control(f) 1/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Profile(f) 1/StaticProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            ...
            new Metric(){Name = "Signals/HighAbort(f) 1/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/HighAlarm(f) 1/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/LowAbort(f) 1/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/LowAlarm(f) 1/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/H(f)/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Control(f) 1/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Profile(f) 1/DynamicProperties", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            ...
            new Metric(){Name = "Signals/HighAbort(f) 1/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/HighAlarm(f) 1/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/LowAbort(f) 1/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/LowAlarm(f) 1/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/H(f)/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Control(f) 1/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
            new Metric(){Name = "Signals/Profile(f) 1/Data", DataType =  (uint)DataType.DataSet, DataSetValue = null},
        ...
        public static List<Metric> CommonMetrics { get; set; } = new List<Metric>()
        {
            ...
            new Metric(){Name = METRIC_NDATA_TEST_RUNLOGEVENT, DataType = (int) DataType.DataSet, DataSetValue = null },//d
        };
